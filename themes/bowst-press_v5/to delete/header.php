		...
		<nav class="navbar navbar-expand-md navbar-light bg-light">
			<div class="container-fluid">
				...
				<?php if ( is_front_page() && is_home() ) : // Default homepage. ?>
					<h1 class="navbar-brand"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo.svg" alt="<?php bloginfo( 'name' ); ?>"></a></h1>
				<?php elseif ( is_front_page() ) : // Static homepage. ?>
					<h1 class="navbar-brand"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo.svg" alt="<?php bloginfo( 'name' ); ?>"></a></h1>
				<?php else : // Everything else. ?>
					<div class="navbar-brand"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo.svg" alt="<?php bloginfo( 'name' ); ?>"></a></div>
				<?php endif; ?>
