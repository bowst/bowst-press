...
function bowst_press_scripts() {
	...
	wp_enqueue_script( 'bowst-press-global-scripts', get_template_directory_uri() . '/public/js/main.js', array( 'jquery' ), filemtime( get_template_directory() . '/public/js/main.js' ), true );
